...
SELECT
	ROUND(SUM(sb::NUMERIC) / (SUM(cs::NUMERIC) + (SUM(sb::NUMERIC))),2) * 100 AS success
FROM batting
...
--	   query, excluding the problem year. How often from 1970 – 2016 was it the case that a team with the most wins
...
--	   this question. As you do this analysis, keep in mind that salaries across the whole league tend to increase together, so you may want to look on a year-by-year basis.
